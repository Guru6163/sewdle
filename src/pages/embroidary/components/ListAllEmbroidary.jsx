...
import { getAllEmbroidaries } from "../../../api/api";
import { useNavigate, useLocation } from "react-router-dom";
import { Badge } from "primereact/badge";
function ListAllEmbroidary() {
  const location = useLocation();
  const navigate = useNavigate();
  const [allEmbroidaries, setAllEmbroidaries] = useState([]);

  useEffect(() => {
    getAllEmbroidaries().then((res) => setAllEmbroidaries(res.data));
  }, [location]);

  console.log(allEmbroidaries);
...
export default ListAllEmbroidary;
